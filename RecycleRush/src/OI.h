...
private:
	...
	Joystick* joystickDriverOnPort2;
	JoystickButton* joystick2Button7;
	JoystickButton* joystick2Button5;
	JoystickButton* joystick2Button4;
	JoystickButton* joystick2Button3;
...
public:
	...
	Joystick* getJoystickDriverOnPort0();
	Joystick* getJoystickGunnerOnPort1();
	Joystick* getJoystickDriverOnPort2();
