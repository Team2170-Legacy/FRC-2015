...
Elevator::Elevator() : Subsystem("Elevator") {
	...
	lowerLimitCounter = new Counter(lowerLimit);
...
void Elevator::InitDefaultCommand() {
	...
	lw->AddSensor("Elevator", "LWlowerLimitCounter", lowerLimitCounter);
}
...
bool Elevator::LowerLimitHasBeenReached() {
	return lowerLimitCounter->Get() > 0;
}
...
void Elevator::ResetLowerLimitCounter() {
	lowerLimitCounter->Reset();
}
...
void Elevator::SmartDashboardOutputs() {
	...
	SmartDashboard::PutNumber("SDBlowerLimitCounter", lowerLimitCounter->Get());
}
