...
Intake::Intake() : Subsystem("Intake") {
	...
	toteLimitCounter = new Counter(toteReceivedLimit);
...
void Intake::InitDefaultCommand() {
	...
	lw->AddSensor("Intake", "LWtoteLimitCounter", toteLimitCounter);
...
bool Intake::ToteLimitHasBeenReached() {
	return toteLimitCounter->Get() >0;
}

void Intake::ResetToteLimitCounter() {
	toteLimitCounter->Reset();
}

void Intake::SmartDashboardOutputs() {
	SmartDashboard::PutNumber("SDBtoteLimitCounter", toteLimitCounter->Get());
}
