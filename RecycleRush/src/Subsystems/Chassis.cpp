...
#define ENCODER_TICS_PER_REV 250.0F
...
Chassis::Chassis() : Subsystem("Chassis")
{
	...
	chassisEncoder = RobotMap::chassisChassisEncoder;
	...
	driveMotors->SetExpiration(2.0);
	chassisEncoder->SetDistancePerPulse(4 * PI / ENCODER_TICS_PER_REV);
}
