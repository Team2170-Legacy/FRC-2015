...
#include "Commands/ElevatorGotoOnePID.h"
#include "Commands/ElevatorGotoTwoPID.h"
#include "Commands/ElevatorGotoZeroPID.h"
...
OI::OI() {
	...
	SmartDashboard::PutData("ElevatorGotoZeroPID", new ElevatorGotoZeroPID());

	SmartDashboard::PutData("ElevatorGotoOnePID", new ElevatorGotoOnePID());

	SmartDashboard::PutData("ElevatorGotoTwoPID", new ElevatorGotoTwoPID());
