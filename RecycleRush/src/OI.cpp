...
#include "Commands/ElevatorGotoLowerSafety.h"
#include "Commands/ElevatorGotoPosition.h"
#include "Commands/ElevatorGotoPositionWithPower.h"
...
#include "Commands/ElevatorPlatformPlaceWithPower.h"
...
#include "Commands/StackDeliverySimple.h"
#include "Commands/StackDeliveryWithBackSupport.h"
...
//	SmartDashboard:: PutNumber("ElevatorPlatformBot",  1.0*654 + 1.5*54);  // 1.0 tote  plus  roughly 1.5 inches to have stack land on 2" platform
	...
	joystickButtonY = new JoystickButton(joystickDriverOnPort0, 4);
	joystickButtonY->WhenPressed(new ElevatorPlatformStage());
	joystickButtonX = new JoystickButton(joystickDriverOnPort0, 3);
	joystickButtonX->WhenPressed(new StackDeliveryWithBackSupport());
	...
	SmartDashboard::PutData("ElevatorGotoLowerSafety", new ElevatorGotoLowerSafety());
